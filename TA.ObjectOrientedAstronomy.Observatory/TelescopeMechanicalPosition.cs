...
public int CompareTo(TelescopeMechanicalPosition? other)
            ...
            var haCompare = this.HourAngle.AsHoursUnwrapped().CompareTo(other.HourAngle.AsHoursUnwrapped());
            if (haCompare != 0)
                return haCompare;
            return this.Declination.AsDegrees().CompareTo(other.Declination.AsDegrees());
            }
